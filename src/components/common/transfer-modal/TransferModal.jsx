...
export const TransferModal = ({ open, onClose, nft }) => {
  const { isComplete, isLoading, transferNft, handleComplete } =
    useTransferNft()
  const {
    register,
    handleSubmit,
    ...
    return (
      <div className='Overlay'>
        <div className='Transfer-Modal-Container'>
          ...
          <form
            style={{ padding: '40px' }}
            onSubmit={handleSubmit(transferNft)}
          >
              ...
              <div className='Section'>
                ...
                <input
                  ...
                  {...register('address', {
                    ...
                    validate: {
                      requiredLength: addr =>
                        addr.length === 42 || 'invalid wallet address'
                    }
                  })}
                />
                <span
                  style={{ fontSize: '16px', color: 'red', paddingTop: '8px' }}
                >
